...
unsigned char SCLink::byteAnalysisCall(const unsigned char rx_byte)
{
...
* History:
***********************************************************************************************************************/
unsigned char SCLink::packageAnalysis(void)
{
    ...
    if (sc_link_node_model == 0)  //the slave need to check the SHAKING_HANDS"s state
    {
    ...
    case CLEAR_ODOMETER_DATA :
        analysis_state=setCommandAnalysis(command_state_, (unsigned char *)&robot->expect_odometer_state, sizeof(robot->expect_odometer_state));
        break;
...
/***********************************************************************************************************************
* Function:    void SCLink::masterSendCommand(Command command)
*
* Scope:       public
*
...
* History:
***********************************************************************************************************************/
unsigned char SCLink::masterSendCommand(const Command command_state)
{
    ...
    case CLEAR_ODOMETER_DATA :
        sendStruct(command_state, (unsigned char *)&robot->expect_odometer_state, sizeof(robot->expect_odometer_state));
        break;
...
* History:
***********************************************************************************************************************/
unsigned char SCLink::readCommandAnalysis(Command command_state , unsigned char* p ,  unsigned short int len)
{
...
unsigned char SCLink::setCommandAnalysis( Command command_state , unsigned char* p ,  unsigned short int len)
{
...
/***********************************************************************************************************************
* Function:    void SCLink::sendStruct(const Command command_state , unsigned char* p , const unsigned short int len)
*
* Scope:       private
*
* Description:
...
*
*
* len>0 :      send a Struct command to the friend sc_link nodeif
...
* History:
***********************************************************************************************************************/
void SCLink::sendStruct(const Command command_type , unsigned char* p ,  unsigned short int len)
{
